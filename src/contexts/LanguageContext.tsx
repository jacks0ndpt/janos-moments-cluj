...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'contact.form.eventType.baptism': 'Baptism',
    ...
    'contact.form.messagePlaceholder': 'Tell me a few details: the date (even approximate), the location and what you wish for.',
  ...
  ro: {
    ...
    'contact.form.eventType.baptism': 'Botez',
    'contact.form.eventType.other': 'Alte evenimente',
    'contact.form.date': 'Data evenimentului',
    'contact.form.location': 'Locație',
    'contact.form.hours': 'Ore estimate',
    'contact.form.message': 'Mesaj',
    'contact.form.messagePlaceholder': 'Spune-mi câteva detalii: data (chiar aproximativă), locația și ce îți dorești.',

...
import { GOOGLE_REVIEWS_URL, type Review, type ServicesContent } from '@/content/servicesPage';
...
const ReviewsSection = ({
  ...
  copy: ServicesContent['reviews'];
  reviews: Review[];
}) => (
  <section id="reviews" className="section-padding scroll-mt-32 bg-card overflow-hidden">
    <div className="container-wide">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-4xl mx-auto">
        {reviews.map((item, i) => (
          ...
          >
            <Quote className="text-primary/20 absolute top-5 right-5" size={28} aria-hidden="true" />
